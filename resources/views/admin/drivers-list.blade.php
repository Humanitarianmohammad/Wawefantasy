                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <?php
                                            if ($val->status == 0) {
                                                print '<span class="chip yellow lighten-5"><span class="yellow-text">Waiting</span></span>';
                                        ...
                                        <th>
                                            <a class="edit mr-4" href="{{ route('approve_user', $val->id) }}">
