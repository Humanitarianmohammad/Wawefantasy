...
<head>
    ...
    {{-- <meta name="csrf-token" content="k2Ba0mIKQ02Po2EmvHgMwetu5S3rvVf3iqzDlwXv"> --}}
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/public/admin_assets/vendors/chartist-js/chartist.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/public/admin_assets/vendors/chartist-js/chartist-plugin-tooltip.css') }}">
    <!-- END: VENDOR CSS-->
...
<body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  "
    ...
    <!-- BEGIN: Footer-->
    <footer class="page-footer footer  footer-static   footer-dark  gradient-shadow gradient-45deg-green-teal">
